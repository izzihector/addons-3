...
class ContractDetails(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', string="Renter", required=True)
    ...
    state = fields.Selection([('new',"New"),('running',"Occopied"),('expire',"Expire"),('cancel','Cancelled')], default="new")
